...
class RequestScreen extends StatefulWidget {
  ...
  const RequestScreen({super.key, required this.hospitalId, required this.userId});
...
void _addRequest(String message, String userName, String userPhone, {String? roomNumber}) {
  ...
  final newRequest = {
    ...
    "status": "Pending", // hospital can update this to "Accepted" or "Resolved"
    "timestamp": timestamp,
  };
  ...
  dbRef
    ...
    ScaffoldMessenger.of(context)
        .showSnackBar(SnackBar(content: Text("Failed to add request: $error")));
  });
}
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (req["roomNumber"] != null && req["roomNumber"].toString().isNotEmpty)
                      Text(
                        "Room: ${req["roomNumber"]}",
                        style: const TextStyle(
                          fontSize: 18,
